...
<body class="font-sans antialiased">
    <div x-data="{ isSidebarOpen: $persist(true), openDropdown: '' }" class="flex min-h-screen bg-gray-100">
        <aside 
            ...
            <nav class="p-4 space-y-2">
                ...
                <div class="relative" 
                    ...
                    <button @click="if (isSidebarOpen) { openDropdown = (openDropdown === 'mcq' ? '' : 'mcq') }" class="w-full flex items-center justify-between py-2 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
                    ...
                    <div x-show="openDropdown === 'mcq'" x-transition
                        ...
                        <a href="#" class="block py-2 px-4 text-sm rounded hover:bg-gray-600">Add New</a>
